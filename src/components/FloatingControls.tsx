    ...
    <div className="fixed bottom-5 right-5 z-[1000]">
      <div className={cn(
        ...
        <div className="flex items-center gap-2.5">
          <label htmlFor="percentageSlider" className="text-sm min-w-[60px] font-light tracking-[0.1em] uppercase text-muted-primary">MANUAL:</label>
          <input 
            type="range" 
            id="percentageSlider" 
            min="0" 
        ...
        <div className="text-sm font-light tracking-[0.1em] uppercase text-muted-primary mb-1">SCENARIOS:</div>
